...
- Pro: $8/month CAD. Monthly limits: 150 resume tailorings, 120 cover letters, 300 auto-apply credits, unlimited tracked applications, 30 strategy feedback runs, 250 networking messages, 150 interview prep sessions. Priority email support. Pro is not unlimited - tracked applications are the one feature with no cap.
