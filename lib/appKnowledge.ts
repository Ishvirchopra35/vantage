...
- Settings: theme (dark/light), replace your base resume, product update email preferences, reset your data (start fresh, keeps the account), or delete the account. The Word template is managed on the Profile page, not here.
